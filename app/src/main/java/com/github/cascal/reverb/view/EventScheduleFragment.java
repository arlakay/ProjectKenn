...
public class EventScheduleFragment extends Fragment {
    ...
    public static EventScheduleFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_event_schedule, container, false);

        final AVLoadingIndicatorDialog dialog=new AVLoadingIndicatorDialog(getActivity());
        dialog.setMessage("Loading");
        dialog.show();

        mWebView = (WebView) rootView.findViewById(R.id.webview_event_schedule);
        ...
        // Use remote resource
        mWebView.loadUrl("http://www.srmbands.com/event-schedule/");
